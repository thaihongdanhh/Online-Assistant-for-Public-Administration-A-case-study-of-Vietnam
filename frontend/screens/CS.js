  ...
  const onSend = async (newMessages = []) => {    
    ...
    try{
      ...
      const requestOptions = {
        ...
        body: JSON.stringify({
          model: "ft:gpt-3.5-turbo-0613:data-science-lab::833cr3hy",
          messages: [{role: 'system', content: 'eco_trad'},{role: 'user', content: messageText}],
          max_tokens: 1024,
          temperature: 0.5,
          n:1,
          stop: null,
      ...
      fetch("http://ai.ailab.vn:5018/model/parse", requestOptions)
      .then(async (response) => {
        // res.send();        
