...
exports.default = parseStreamedGptResponse;
/**
 ...
 * @param data
 */
function parseStreamedGptResponse(data) {
  ...
  return {
    ...
    isDone: ((_response$message = response.message) === null || _response$message === void 0 ? void 0 : _response$message.end_turn) === true
  };
}
//# sourceMappingURL=parseStreamedGptResponse.js.map